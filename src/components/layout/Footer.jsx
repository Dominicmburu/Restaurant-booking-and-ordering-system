        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center mb-4">
              <div className="bg-warning d-inline-block text-dark p-2 rounded">
                <h3 className="mb-0">AlDiner</h3>
              </div>
              <p className="mt-3">London’s #1 Food Delivery Platform—bringing local flavors to your door.</p>
            </div>
          </div>
          ...
          <div className="row text-center">
            <div className="col-12">
              ...
              <p className="mb-0">AlDiner &copy; 2025 - All Rights Reserved</p>
            </div>
          </div>
        </div>
      </footer >
